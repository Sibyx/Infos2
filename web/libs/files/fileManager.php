...
class fileManager {
	...
	public function moveFile($moveTo) {
		if ($this->valid == true) {
			if (move_uploaded_file($this->filePath, $moveTo . $this->fileName)) {
				$this->filePath = $moveTo . $this->fileName;
				return true;
			}
			else {
				return false;
	...
	public function setFilePath($value) {
		$this->filePath = str_replace(' ', '', $value);
	}
	
	public function setFileExt($value) {
		$value = strtolower($value);
		if (in_array($value, $this->uploadExtensions)) {
			$this->fileExt = $value;
		}
		else {
			$this->valid = false;
	...
	public function setFileMime($value) {
		if (in_array($value, $this->uploadMimes)) {
			$this->fileMime = $value;
		}
		else {
			$this->valid = false;
