    ...
    <div class="large-12 columns">
        <header class="row">
            ...
            <div class="small-4 columns text-right">
                <a href="{siteurl}/announcements/edit/{announcementId}"><img src="{siteurl}/views/{defaultView}/images/edit.png" alt="{lang_editAnnouncement}" title="{lang_editAnnouncement}" /></a>
                <a href="{siteurl}/announcements/remove/{announcementId}"><img src="{siteurl}/views/{defaultView}/images/delete.png" alt="{lang_removeAnnouncement}" title="{lang_removeAnnouncement}" style="margin-left: 10px"/></a>
            </div>
        </header>
        <div class="row">
            <div class="large-12 columns">
